...
public class QfReaderTest {
    ...
    @Test
    void preservesUnknownProperties() throws Exception {
        ...
        String json =
                ...
                "  \"format_version\": \"0.1\",\n" +
                "  \"metadata\": {\n" +
                "    \"id\": \"org.scivault.test.unknown-properties\",\n" +
        ...
        try {
            ...
            QuestionBank bank = QfReader.read(tempFile);
            ...
            if (VERBOSE) {
                System.out.println();
                System.out.println(
                        "=== QfReader: unknown property preservation ==="
                );
